...
// This is just the declaration of the struct:
...
// Here we define an array containing a few Radio Stations
// Now we have memory allocated and values initialized
// However, there is no redefinition of the struct!
//
